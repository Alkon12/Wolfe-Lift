      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="block text-red-600 stroke-white stroke-2">{t.services.title.split(' ').slice(1).join(' ')}</span>
          </motion.h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 items-center">
              <div className="flex items-center justify-center sm:justify-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-white font-black text-sm uppercase tracking-wider">24/7</p>
                  <p className="text-white/80 text-xs uppercase">DISPONIBLE</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center sm:justify-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-white font-black text-sm uppercase tracking-wider">FREE</p>
              ...
              <div className="flex items-center justify-center sm:justify-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-white font-black text-sm uppercase tracking-wider">BEST</p>
