export const translations = {
  en: {
    ...
    hero: {
      ...
      mainTitle1: "RENT AN ELECTRIC",
      mainTitle2: "SCISSOR LIFT",
      mainTitle3: "FROM US TODAY",
  ...
  es: {
    ...
    hero: {
      ...
      mainTitle1: "RENTA UNA PLATAFORMA",
      mainTitle2: "ELEVADORA ELÉCTRICA",
      mainTitle3: "HOY MISMO",
